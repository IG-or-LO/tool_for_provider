...
//............
/*закоментированы примеры вызова функций для задания стилей эллементов интрефейса
    static QString getRegWidgetStyle();
    static QString getLoginAndPasswordEditStyle();
    static QString getLoginAndPasswordTextStyle();
   ...
   static QString getButtonStyle2();
   */
};
